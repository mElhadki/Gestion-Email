...
exit();
 ...
 $sql = "SELECT client.*, employee.UName FROM `client` ,`employee` WHERE client.E_ID = employee.E_ID and  employee.UName = '".$_SESSION['User']."' and client.interesse = 'Yes' GROUP BY client.C_ID";
    if (!$sql) {
