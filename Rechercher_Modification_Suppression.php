...
$C_ID=$_GET['GetC_ID'];
$query="select * from client where C_ID ='".$C_ID."'";
  ...
  <div class="container-fluid">
   ...
   <ul class="nav navbar-nav">
      <li ><a href="Welcome.php">Home</a></li>
         ...
         <li><a href="Black_Liste.php">Black Liste </a></li>
    </ul>
...
<form  action="Modification_Client.php?C_ID=<?php echo $C_ID ?>" method="post" enctype="multipart/form-data" >
    <center><h2>Modify Customer </h2></center>
                <hr/>
<div class="alert alert-error"></div>
<div class="form-group">  
    <label for="C_ID" class="control-label">ID</label>    
<input type="text" name="C_ID" placeholder="C_ID" value="<?php echo $C_ID ?>"  class="form-control" required>
...
<input type="text" name="Email2" placeholder="Email2" value="<?php echo $Email2 ?>"  class="form-control" >
    
    <label for="C_origine" class="control-label">C_origine</label>  
<select id="ddl" name="C_origine" value="<?php echo $C_origine ?>" class="form-control" > 
...
<input type="text" name="Middle_Name" value="<?php echo $Middle_Name ?>" placeholder="Middle_Name" class="form-control">
    
    <label for="Fonction" class="control-label">Fonction</label>  
<input type="text" name="Fonction" value="<?php echo $Fonction ?>" placeholder="Fonction" class="form-control" >
    
    <label for="Company" class="control-label">Company</label>  
<input type="text" name="Company" value="<?php echo $Company ?>" placeholder="Company" class="form-control">
...
<input type="text" name="Phone_Number" value="<?php echo $Phone_Number ?>" placeholder="Phone_Number" class="form-control">
    
    <label for="interesse" class="control-label">interesse</label>  
<select name="interesse" class="form-control" value="" placeholder="interesse" > 
               <option>Non</option>
...
<select name="Black_Liste" class="form-control" autocomplete="off" > 
               ...
               <hr/>
<center><input type="submit" name="btn-login" value="Edit" class="btn btn-primary"></center>    
                </div>  </form> </div>
</body></html>