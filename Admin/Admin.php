...
<div class="wrapper fadeInDown">
 ...
 <form action="Proce.php" method="post">
      ...
      <input type="text" id="login" class="fadeIn second" name="A_Login" placeholder="login">
     
      <input type="password" id="password" class="fadeIn third" name="A_Passw" placeholder="Password">
