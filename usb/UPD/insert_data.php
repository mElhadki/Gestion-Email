...
if(empty($_POST["Fonction"]))
 ...
 if($error == '')
 {
  ...
  (C_origine, Email, First_name, Last_name, Middle_name,Fonction, Phone_Number, Company,Country,Interested,Source, images) 
  VALUES (:C_origine,:Email,:First_name,:Last_name, :Middle_name,:Fonction,:Company,:Phone_Number,:Country,:Interested,:Source,:images)
  ";
