...
<div class="form-group">
 ...
 <textarea name="First_name" id="First_name" class="form-control"></textarea>
</div>
<div class="form-group">
...
<label>	Source </label>  <br>    
               <input list="browsers" id="Source" name="Source" class="form-control">
...
<script>
 $(document).ready(function () {
  ...
  var Middle_name = localStorage.getItem('Middle_name');
     ...
     var Interested = localStorage.getItem('Interested');
     var Source = localStorage.getItem('Source');
  var images = localStorage.getItem('images');

  $('#C_origine').val(C_origine);
  $('#Email').val(Email);
