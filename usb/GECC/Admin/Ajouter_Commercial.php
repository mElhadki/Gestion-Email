...
<li  class="active"><a href="Ajouter_Commercial.php"> Add Commercial  </a></li>
...
<div class="container">
    <div class="container">
        <div style="width: 500px; margin: 50px auto;">
            <form method="post" action="Fonction_Ajouter_Commercial.php" autocomplete="off">
                <center><h2>Add a Commercial </h2></center>
                <hr/>
