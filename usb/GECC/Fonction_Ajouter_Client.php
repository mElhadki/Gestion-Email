...
if(
isset($_POST['C_origine'],$_POST['First_name'],
      $_POST['Last_name'],$_POST['Middle_Name'],
      $_POST['Fonction'],$_POST['Company'],
      $_POST['Country'],$_POST['Email'],
      $_POST['Phone_Number'],$_POST['interesse'],
      $_POST['Source'],$_POST['Website'],
      $_POST['Category'], $_POST['Advanced_diploma'],
...
if(!mysqli_query($con,"INSERT INTO client SET C_origine='".$_POST['C_origine']."',First_name='".$_POST['First_name']."', 
Last_name='".$_POST['Last_name']."', Middle_Name='".$_POST['Middle_Name']."', Fonction='".$_POST['Fonction']."', Company='".$_POST['Company']."', Country='".$_POST['Country']."', Email='".$_POST['Email']."', Phone_Number='".$_POST['Phone_Number']."',interesse='".$_POST['interesse']."',Source='".$_POST['Source']."',Website='".$_POST['Website']."',Category='".$_POST['Category']."',Advanced_diploma='".$_POST['Advanced_diploma']."',Foundation_diploma='".$_POST['Foundation_diploma']."',Certificate='".$_POST['Certificate']."',training_lang='".$_POST['training_lang']."',Black_Liste='".$_POST['Black_Liste']."', E_ID=". $id[0]))
