...
$result = $con->query($sql);
    if ($result->num_rows > 0) {
          ...
          <th>Black_List</th>
           <th>Category</th>
          <th>Advanced_diploma</th>
          <th>Foundation_diploma</th>
          <th>Certificate</th>
          <th>training_lang</th>
          </tr>
          ";
...
echo "<tr><td>" . $row['C_ID'] . "</td><td>" . $row['C_origine'] . "</td><td>" . $row['Email'] . "</td><td>" . $row['Source'] . "   " . $row['Website'] . "</td><td>" . $row['First_name'] . "</td><td>" . $row['Last_name'] . "</td><td>" . $row['Middle_Name'] . "</td><td>" . $row['Fonction'] . "</td><td>" . $row['Company'] . "</td><td>" . $row['Country'] . "</td><td>" . $row['Phone_Number'] . "</td><td>" . $row['interesse'] . "</td><td>" . $row['Date_Inscr'] . "</td><td>" . $row['Black_Liste'] . "</td><td>" . $row['Category'] . "</td><td>" . $row['Advanced_diploma'] . "</td><td>" . $row['Foundation_diploma'] . "</td><td>" . $row['Certificate'] . "</td><td>" . $row['training_lang'] . "</td></tr>";  //$row['index'] the index here is a field name
}
  echo "</table>";
}
    else {
