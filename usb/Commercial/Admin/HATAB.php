...
<li class="active"><a href="HATAB.php">HATAB</a></li>
...
exit();
    ...
    ini_set('max_execution_time', 100);
      echo '<center><h3> HATAB !</h3><center><br><br><br>';
...
$sql =   " SELECT client.*, employee.UName FROM `client` , `employee` WHERE client.E_ID = employee.E_ID and  employee.E_ID = '3' GROUP BY client.C_ID";
    if (!$sql) {
