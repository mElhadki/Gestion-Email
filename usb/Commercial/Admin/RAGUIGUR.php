...
<li  class="active"><a href="RAGUIGUR.php"> RAGUIGUE  </a></li>
...
exit();
      ...
      echo '<center><h3> RAGUIGUE !</h3><center><br><br><br>';
...
$sql =   " SELECT client.*, employee.UName FROM `client` , `employee` WHERE client.E_ID = employee.E_ID and  employee.E_ID = '' GROUP BY client.C_ID";
    if (!$sql) {
