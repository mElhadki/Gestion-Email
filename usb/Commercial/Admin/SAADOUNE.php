...
<li  class="active"><a href="SAADOUNE.php"> SAADOUNE  </a></li>
...
exit();
      ...
      echo '<center><h3> SAADOUNE !</h3><center><br><br><br>';
...
$sql =   " SELECT client.*, employee.UName FROM `client` , `employee` WHERE client.E_ID = employee.E_ID and  employee.E_ID = '1' GROUP BY client.C_ID";
    if (!$sql) {
