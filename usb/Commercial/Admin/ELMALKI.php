...
<li><a href="SEMKALI.php"> ELMKALI </a></li>
<li><a href="SAADOUNE.php"> SAADOUNE  </a></li>
<li><a href="HATAB.php">HATAB</a></li>
<li class="active"><a href="HAKMI.php"> HAKMI   </a></li>
...
exit();
    ...
    ini_set('max_execution_time', 100);
      echo '<center><h3> ELMKALI !</h3><center><br><br><br>';
$sql =   " SELECT client.*, employee.UName FROM `client` , `employee` WHERE client.E_ID = employee.E_ID and  employee.E_ID = '2' GROUP BY client.C_ID";
    if (!$sql) {
