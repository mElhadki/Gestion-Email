...
<body>
       ...
       <label> Cargo Surveying Training </label>
          <label> Marine Surveying Training </label>
        <label> Shipping Management Training </label>
          <label> SMS / QSHE Standards Training </label>
        <label> Classification and Statutory Training</label>
