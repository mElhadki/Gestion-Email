...
?>
    <div style="width: 500px; margin: 50px auto;">
            <form name="findCourseForm" method="post" action="Modification_Client.php" autocomplete="off">
...
exit();
         ...
         echo '<center><h3><a> Customer Modification !</a></h3><center>';
